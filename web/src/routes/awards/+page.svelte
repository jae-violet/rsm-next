...
<SeoHead
	...
	description="We communicate the authenticity of a project’s message in a way that adds meaning and brings value to the team’s purpose. RSM Design has developed hundreds of successful branded environments for cities, communities, mixed-use properties, retail projects, hotels, and restaurants."
/>
